<template>
  <div v-if="isVisible && persona" class="modal-overlay" @click="onOverlayClick">
...
async function onSubmit(values: any) {
  ...
  try {
    const datosModificacion: ModificarPersona = {
    ...
    const personaActualizada = await personasStore.actualizarPersona(props.persona.id, datosModificacion);
